...
public class Swerve extends SubsystemBase {
    ...
    public Swerve() {
        ...
        mSwerveMods = new SwerveBase[] {
            ...
            new SwerveBase(1, Constants.Swerve.Mod1.constants),
            new SwerveBase(2, Constants.Swerve.Mod2.constants),
            new SwerveBase(3, Constants.Swerve.Mod3.constants)
        };
    ...
    public void drive(Translation2d translation, double rotation, boolean fieldRelative, boolean isOpenLoop) {
        ...
        for(SwerveBase mod : mSwerveMods){
