...
public class MAXSwerveModule {
   ...
   * Encoder.
   */
  public MAXSwerveModule(int drivingCANId, int turningCANId,  int cancoderCANId,double chassisAngularOffset) {
