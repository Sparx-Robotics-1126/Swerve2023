...
public class DriveSubsystem extends SubsystemBase {
  ...
  public final SwerveModuleBase m_frontLeft = new SwerveModuleBase(
      ...
      isOpenLoop,
      CANIDConstants.kFrontLeftTurningOffset);

  public final SwerveModuleBase m_frontRight = new SwerveModuleBase(
      ...
      isOpenLoop,
      CANIDConstants.kFrontRightTurningOffset);

  public final SwerveModuleBase m_backLeft = new SwerveModuleBase(
      ...
      isOpenLoop,
      CANIDConstants.kRearLeftTuriningOffsset);

  public final SwerveModuleBase m_backRight = new SwerveModuleBase(
      ...
      PDPConstants.BACK_LEFT_TURN_CHANNEL,
      isOpenLoop,
      CANIDConstants.kRearRightTurningOffset);
  ...
  public void jogTurnModule(SwerveModuleBase i, double speed) {
    i.turnMotorMove(speed);
  }

  public void positionTurnModule(SwerveModuleBase i, double angle) {
    i.positionTurn(angle);
  }

  public void driveModule(SwerveModuleBase i, double speed) {
    i.driveMotorMove(speed);
  }

  public boolean getTurnInPosition(SwerveModuleBase i, double targetAngle) {
