...
public class ShuffleboardContent {
        ...
        public static void initBooleanShuffleboard(SwerveModuleBase m_sm) {
        ...
        public static void initDriveShuffleboard(SwerveModuleBase m_sm) {
        ...
        public static void initTurnShuffleboard(SwerveModuleBase m_sm) {
        ...
        public static void initCoderBooleanShuffleboard(SwerveModuleBase m_sm) {
        ...
        public static void initCANCoderShuffleboard(SwerveModuleBase m_sm) {
                int locationIndex = m_sm.m_locationIndex;
                String abrev = m_sm.modAbrev[locationIndex];
